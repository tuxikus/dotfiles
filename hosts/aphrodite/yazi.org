...
#+begin_src toml :tangle ~/.config/yazi/theme.toml
[flavor]
...
#+begin_src toml :tangle ~/.config/yazi/flavors/catppuccin-latte.yazi/flavor.toml
...
progress_normal = { fg = "#40a02b", bg = "#bcc0cc" }
progress_error  = { fg = "#df8e1d", bg = "#d20f39" }
...
rules = [
	...
	# Virtual file system
	{ mime = "vfs/{absent,stale}", fg = "#7c7f93" },
	# Fallback
	{ url = "*", fg = "#4c4f69" },
	{ url = "*/", fg = "#1e66f5" },
	# TODO: remove
...
#+begin_src xml :tangle ~/.config/yazi/flavors/catppuccin-latte.yazi/tmtheme.xml
