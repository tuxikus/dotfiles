...
#+begin_src fish :eval never :tangle out/fish/.config/fish/config.fish
set -g fish_greeting ""
...
#+begin_src conf :tangle out/fish/.config/fish/themes/catppuccin-latte.theme
